...
const SingleImageQA: React.FC = () => {
  const [image, setImage] = useState<ImageFile | null>(null);
  const [question, setQuestion] = useState<string>('What is in the image?');
  ...
  return (
    <FeatureContainer 
      title="Single-Image Q&A"
      description="Upload an image and ask a question. The AI will analyze the image to provide an answer."
    >
      <div className="space-y-6">
        <div>
          ...
          />
          {image && <img src={image.preview} alt="Preview" className="mt-4 rounded-lg max-h-60" />}
        </div>
